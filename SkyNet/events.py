...
#
"""SkyNet module for managing events. One of the main components of the SkyNet."""
...
from SkyNet import bot, BOTLOG_CHATID, LOGSPAMMER
...
def register(**args):
    ...
    def decorator(func):
        async def wrapper(check):
            ...
            try:
                from SkyNet.modules.sql_helper.blacklist_sql import get_blacklist
